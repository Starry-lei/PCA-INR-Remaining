...
from dataset.data_loader_denoising import shapelvlCompDataset,RandomPairSampler,paired_collate_fn
...
def train(args, log_dir=None):
    ...
    dataset_train = shapelvlCompDataset(args, 'train')
    ...
    dataset_val= shapelvlCompDataset(args, 'val')
    ...
    for epoch in range(num_epochs):
        ...
        for data_tensors  in tqdm_train_loader:
            ...
            # exit()
            ret= model(pca_input, gt=gt_5k_points)

            _, _, _, pred = ret

            sparse_loss, dense_loss = model.get_loss(ret, gt_5k_points, epoch)

            # print("show points shape of sparse_loss:",sparse_loss.shape)
            # print("show points val of sparse_loss:",sparse_loss)
            # print("show points shape of dense_loss:",dense_loss.shape)
            # print("show points val of dense_loss:",dense_loss)
            # print("show points pred:",pred.shape)
            # exit()
        ...
        with torch.no_grad():
            ...
            for name, gt_5k_points, pca_input in dataloader_val:
                ...
                sparse_loss_l1 =  ChamferDisL1(coarse_points, gt_5k_points)
                sparse_loss_l2 =  ChamferDisL2(coarse_points, gt_5k_points)
                dense_loss_l1 =  ChamferDisL1(dense_points, gt_5k_points)
                dense_loss_l2 =  ChamferDisL2(dense_points, gt_5k_points)
...
if __name__ == '__main__':
    ...
    # python train_PointCompletion_Shape_level.py -c cfgs/config_shape_lvl_comple.yaml # for shape lvl
