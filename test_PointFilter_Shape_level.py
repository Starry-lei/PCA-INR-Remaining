...
def train(args, log_dir=None):
    ...
    if load_params:
        ...
        checkpoint_path ="/home/stud/chengl/storage/user/PCA-INR-Remaining/PCA_denoiser/point2ssm_dgcnn_2025-02-10T09-54-54/latest_model_weights.pth"
    ...
    for epoch in range(global_step, num_epochs):
        ...
        print("show avg test loss:",val_loss)
...
if __name__ == '__main__':
   ...
   # python test_PointFilter_Shape_level.py -c cfgs/config_shape_lvl.yaml # for shape lvl
