...
class Model(nn.Module):
    def __init__(self, args):
        ...
        #     nn.Linear(pca_dim, n_basis),
        #     nn.Tanh()  # Bounded activation since residuals are small
        # )
    ...
    def forward(self, pca_recon_displancement, pca_rep):
        ...
        basis_coeffs = self.coeff_predictor(pca_rep)
        residual = torch.matmul(basis_coeffs, self.basis)
