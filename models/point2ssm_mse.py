...
class FlashAttentionCrossAttention(nn.Module):
    def __init__(self, d_model, num_heads, dropout=0.0, device=None, dtype=None):
        super().__init__()
        self.mha = MHA(
            embed_dim=d_model,
            num_heads=num_heads,
    ...
    def forward(self, query, key, value, attn_mask=None):
        ...
        """
        out, _ = self.mha(query, key, value, key_padding_mask=attn_mask)
        return out
