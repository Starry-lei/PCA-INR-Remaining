...
class Model(nn.Module):
    ...
    def forward(self, points, pca_theta, pca_res_latents=None, shape_name= None,
        ...
        # initial_latents= self.pcaReconsLatentsAdapter(points,pca_theta)


        # print("show shape of initial_latents:",initial_latents.shape)
        # exit()


        # predict latents for pca reconstuction
        ...
        # print("show is_nonzero shape:",is_nonzero.shape) # torch.Size([8, 2]), # 8,2,4 for 4 locals
        ...
        # print("show shape of latent_sequence:",latent_sequence.shape)#torch.Size([8, 2, 16]) # [8, 2, 4, 12
        # print("show shape of is_nonzero_mask:",is_nonzero_mask.shape)#3,2,2 # [3, 8, 2, 4]
        # # exit()
